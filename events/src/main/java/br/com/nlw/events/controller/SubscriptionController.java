...
public class SubscriptionController {
    ...
    public ResponseEntity<?> createSbuscription(@PathVariable String prettyName, @RequestBody User subscriber, @PathVariable (required = false) Integer userId){
        try {
    ...
    public ResponseEntity<?> generateRankingByEventAndUsee(@PathVariable String prettyName, @PathVariable Integer userId){
